...
u16int ascii[128] = {
    ...
    0x1071,0x1177,0x1265,0x1372,0x1474,0x1579,0x1675,0x1769,0x186F,0x1970,0x1A5B,0x1B5D,'\n'  ,0x1D00,0x1E61,0x1F73,
    ...
    0x4000,0x4100,0x4200,0x4300,0x4400,0x4500,0x4600,0x4700,0x4800,0x4900,0x4A2D,0x004B,0x4C00,0x004D,0x4E2B,0x4F00,
    0x5000,0x5100,0x5200,0x5300,0x5400,0x5500,0x5600,0x8500,0x8600,0x0000,0x0000,0x5B00,0x5C00,0x5D00
};


u16int withShift[128] = {
  0x0000,0x001B,0x0221,0x0340,0x0423,0x0524,0x0625,0x075E,0x0826,0x092A,0x0A28,0x0B29,0x0C5F,0x0D2B,0x0E08,'\t'  ,
  0x1051,0x1157,0x1245,0x1352,0x1454,0x1559,0x1655,0x1749,0x184F,0x1950,0x1A7B,0x1B7D,'\n'  ,0x001D,0x1E41,0x1F53,
  0x2044,0x2146,0x2247,0x2348,0x244A,0x254B,0x264C,0x273A,0x2822,0x297E,0x2A00,0x2B7C,0x2C5A,0x2D58,0x2E43,0x2F56,
  0x3042,0x314E,0x324D,0x333C,0x343E,0x353F,0x3600,0x372A,0x0038,0x3920,0x3A00,0x5400,0x5500,0x5600,0x5700,0x5800,
...
void keyboardCallback() {
	...
	if (!(scancode & 0x80)) {
		if (scancode == 42 || scancode == 54) {
			...
			if (shift) {
				printf("%c", withShift[scancode]);
			} else {
				printf("%c", ascii[scancode]);
			}
		}
