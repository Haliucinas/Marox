#ifndef MAROX_SYSCALL_H
#define MAROX_SYSCALL_H
...
DECL_SYSCALL1(malloc, int)
DECL_SYSCALL1(free, void*)
DECL_SYSCALL1(exit, int)
DECL_SYSCALL0(waitForKey)
DECL_SYSCALL1(getLine, char*)

DECL_SYSCALL0(shmGet)
DECL_SYSCALL1(shmRelease, int)
DECL_SYSCALL2(shmWrite, int, char*)
DECL_SYSCALL2(shmRead, int, char*)


#endif /* MAROX_SYSCALL_H */
