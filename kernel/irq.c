...
static void updateIrqMask(uint16_t mask) {
...
void irqInit(void) {
    // IRQ mask to 0xFFFB disables all IRQs except the cascade (for slave PIC)
    g_irq_mask = 0xFFFB;
    irqRemap();

    idtSetIntGate(IRQ_ISR_START, (uintptr_t)irq0, KERNEL_DPL);
    idtSetIntGate(IRQ_ISR_START + 1, (uintptr_t)irq1, KERNEL_DPL);
    idtSetIntGate(IRQ_ISR_START + 2, (uintptr_t)irq2, KERNEL_DPL);
    idtSetIntGate(IRQ_ISR_START + 3, (uintptr_t)irq3, KERNEL_DPL);
    idtSetIntGate(IRQ_ISR_START + 4, (uintptr_t)irq4, KERNEL_DPL);
    idtSetIntGate(IRQ_ISR_START + 5, (uintptr_t)irq5, KERNEL_DPL);
    idtSetIntGate(IRQ_ISR_START + 6, (uintptr_t)irq6, KERNEL_DPL);
    idtSetIntGate(IRQ_ISR_START + 7, (uintptr_t)irq7, KERNEL_DPL);
    idtSetIntGate(IRQ_ISR_START + 8, (uintptr_t)irq8, KERNEL_DPL);
    idtSetIntGate(IRQ_ISR_START + 9, (uintptr_t)irq9, KERNEL_DPL);
    idtSetIntGate(IRQ_ISR_START + 10, (uintptr_t)irq10, KERNEL_DPL);
    idtSetIntGate(IRQ_ISR_START + 11, (uintptr_t)irq11, KERNEL_DPL);
    idtSetIntGate(IRQ_ISR_START + 12, (uintptr_t)irq12, KERNEL_DPL);
    idtSetIntGate(IRQ_ISR_START + 13, (uintptr_t)irq13, KERNEL_DPL);
    idtSetIntGate(IRQ_ISR_START + 14, (uintptr_t)irq14, KERNEL_DPL);
    idtSetIntGate(IRQ_ISR_START + 15, (uintptr_t)irq15, KERNEL_DPL);
}
 ...
 */
void baseIrqHandler(struct regs *r) {
